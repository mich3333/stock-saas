    ...
    <div className="auth-shell min-h-screen flex items-center justify-center px-4 relative">
      ...
      >
        <Link href="/" className="flex items-center gap-2 mb-8">
          ...
          <div>
            <div className="section-kicker text-[11px]">Secure access</div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div className="flex justify-end">
            <Link href="/forgot-password" className="text-xs text-[var(--text-secondary)] hover:text-[var(--accent)] transition-colors">
              Forgot password?
            </Link>
          </div>
        ...
        <p className="text-center text-sm text-[var(--text-secondary)] mt-6">
          ...
          <Link href="/register" className="text-[var(--accent)] hover:opacity-80 font-medium transition-colors">
            Sign up
          </Link>
        </p>
      </motion.div>
